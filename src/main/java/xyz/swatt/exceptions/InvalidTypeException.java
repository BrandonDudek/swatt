...
/**
 * A generic Exception that should be thrown when one type is expected but another type is found.
 *
...
public class InvalidTypeException extends AbstractSwattException {
	 ...
	 */
	public InvalidTypeException(String _message) {
		super(_message);
	}
	 ...
	 */
	public InvalidTypeException(Throwable _cause) {
		super(_cause);
	}
	 ...
	 */
	public InvalidTypeException(String _message, Throwable _cause) {
